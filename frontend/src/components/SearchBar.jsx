    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full border border-slate-300 rounded-lg pl-10 pr-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      {open && items.length > 0 && (
        <div className="absolute z-20 mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-lg">
          {items.map((it, i) => (
            ...
            >
              <div className="font-medium text-slate-900 truncate">{it.label.split(',')[0]}</div>
